...
const secondStepWords = ["Камри", "Зайка", "Валентинка"]; // Массив слов для второго шага

const quizQuestions = [ // Массив вопросов для третьего шага
    {
        question: "Какая дата нашего знакомства?",
        options: ["27.11.2023", "02.12.2023", "16.11.2023", "18.11.2023"],
        correctAnswer: "16.11.2023"
    },
    {
        question: "В каком корпусе мы с тобой встретились в первый раз на едине?",
        options: ["ИНМИТ", "ИНЭУ", "ИРИТ", "ФТИ"],
        correctAnswer: "ИНЭУ"
    },
    {
        question: "Что было в первом подарке который я подарил тебе?",
        options: ["Чай и варенье", "Чай и мёд", "Носки", "Значок и ручка"],
        correctAnswer: "Чай и варенье"
    }
];

const valentinText = "Эта валентинка для моей любимой Шанель!" // Текст для финального шага
